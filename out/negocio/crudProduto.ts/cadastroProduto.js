...
var CadastroProduto = /** @class */ (function (_super) {
    ...
    CadastroProduto.prototype.cadastrar = function () {
        ...
        var id = this.entrada.receberTexto("Por favor, insira o c\u00F3digo de identifica\u00E7\u00E3o do produto: ");
        var nome = this.entrada.receberTexto("Por favor, informe o nome do produto: ");
        var preco = this.entrada.receberNumero("Por favor, informe o pre\u00E7o do produto R$: ");
        var produto = new produto_1.default(id, nome, preco);
