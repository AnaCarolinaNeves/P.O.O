...
var ListagemClientes = /** @class */ (function (_super) {
    ...
    ListagemClientes.prototype.listar = function () {
        ...
        this.clientes.forEach(function (cliente) {
            ...
            console.log("Data de emiss\u00E3o CPF " + cliente.getCpf.getDataEmissao);
            var rgs = cliente.getRgs;
            for (var i = 0; i < rgs.length; i++) {
                console.log("Rg: " + rgs[i].getValor);
            }
            for (var i = 0; i < rgs.length; i++) {
                console.log("Data Emiss\u00E3o RG: " + rgs[i].getDataEmissao);
            }
            var telefones = cliente.getTelefones;
            for (var i = 0; i < rgs.length; i++) {
                console.log("DDD: " + telefones.[i].getDdd);
            }
            for (var i = 0; i < rgs.length; i++) {
                console.log("N\u00FAmero de telefone: " + telefones.[i].getTelefones);
            }
            console.log("--------------------------------------");
        });
        console.log("\n");
