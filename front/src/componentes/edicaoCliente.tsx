...
class EdicaoCliente extends Component<props> {
    private nome: string
    ...
    public atualizarFormulario(evento: any) {
                        ...
                        <div className="card-content">
                            <div className="row">
                                <div className="input-field col s4">
                                    <input defaultValue={this.props.cliente.nome} onChange={this.capturarNome} id="nome" type="text" className="validate active" />
